...
public class ToggleWorthCommand
implements CommandExecutor {
    private final DonutSell plugin;

    public ToggleWorthCommand(DonutSell plugin) {
        this.plugin = plugin;
        Objects.requireNonNull(plugin.getCommand("toggleworth"), "Command 'toggleworth' not found in plugin.yml").setExecutor((CommandExecutor)this);
    }
